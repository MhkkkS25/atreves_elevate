...
const Contact = () => {
  ...
  const [errors, setErrors] =
    useState<Partial<ContactFormData>>({});
  ...
  const handleSubmit = async (
    ...
    if (!result.success) {
      ...
      result.error.errors.forEach((error) => {
        const field =
          error.path[0] as keyof ContactFormData;
    ...
    try {
      ...
      await emailjs.send(
        ...
        'template_mzcbrkg',
        {
          ...
          to_email:
            'f20230148@hyderabad.bits-pilani.ac.in',
        },
        'le-k0bAJcVyNmWmUy'
      );
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      TBI, BITS Pilani – Hyderabad Campus
                      <br />
            ...
            <div className="card-luxury">
              ...
              {isSubmitted ? (
                ...
                <div className="text-center py-12">
                  ...
                  <h4 className="heading-card text-foreground mb-3">
                    Thank You!
                  </h4>
